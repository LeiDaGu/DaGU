...
<body>
	<h3>显示团队经理</h3>
	<form action="${pageContext.request.contextPath }/user/displayUserByMultiConditionGroup.do">
		...
		<a href="${pageContext.request.contextPath }/user/doAddUserGroup.do">添加团队经理</a>
	</form><br/>
	<table>
		<tr>
			<th>用户账号</th>
