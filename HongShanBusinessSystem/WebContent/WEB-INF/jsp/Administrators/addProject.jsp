...
<script type="text/javascript">
	function findProject(){
		...
		$.ajax({
			type:'POST',
			url:'${pageContext.request.contextPath }/sameProject/findProjectName.do',
			data: {
...
<body>
<form action="${pageContext.request.contextPath}/adminiProject/addProject.do">
    <table>
        <tr>
            <td>项目名称</td>
            <td><input id="project_name" type="text" name="project_name" onchange="findProject()"></td>
        </tr>
        <tr>
            <td>项目平台</td>
